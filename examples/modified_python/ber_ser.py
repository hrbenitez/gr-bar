...
# Generated: Thu Mar 14 20:22:28 2019
##################################################

# Usage: 
# python2 ber_ser.py <frequency> <distance> <rx gain> <tx attenuation> <rx id> <tx id> <modulation> <threshold>
...
class ber_ser(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        labels = ['BER', 'SER', 'Latency', 'Bit Error Rate', 'Symbol Error Rate',
                  'SNR', '', '', '', '']
        units = ['', '', 'ms', '', '',
                 'dB', '', '', '', '']
        ...
        self.connect((self.blks2_error_rate_0_0, 0), (self.qtgui_number_sink_0, 1))
